...
# Display filter column selection immediately after ZIP upload
if uploaded_zip:
    with zipfile.ZipFile(uploaded_zip, "r") as z:
        ...
        segment_button = st.sidebar.button("🚀 Segment Beads and Analyze")
        ...
        if segment_button:
            ...
            st.success("✅ Full workflow completed and aligned with your required logical structure.")
